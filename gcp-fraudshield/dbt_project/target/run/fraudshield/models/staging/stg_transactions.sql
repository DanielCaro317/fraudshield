  ...
  create or replace view `llm-496117`.`fraud_dbt`.`stg_transactions`
  OPTIONS()
  as -- Limpieza y normalización de las transacciones crudas.
with source as (
    select * from `llm-496117`.`fraud_raw`.`transactions`
),
